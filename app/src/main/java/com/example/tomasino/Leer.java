...
public class Leer extends AppCompatActivity {
    ...
    private final ArrayList<String> arreglo = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            int correo = c.getColumnIndex("correo");
            ...
            if(c.moveToFirst())
            {
                do{
                    ...
                    persona.correo = c.getString(correo);
                    persona.mensaje = c.getString(mensaje);
                    lista.add(persona);

                    arreglo.add(c.getString(id) + " \t " + c.getString(nombre) + " \t "  + c.getString(correo) + " \t "  + c.getString(mensaje) );
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, android.view.View view, int position, long l) {
                    ...
                    i.putExtra("correo",persona.correo);
                    i.putExtra("mensaje",persona.mensaje);
                    startActivity(i);
                }
            });
        }
